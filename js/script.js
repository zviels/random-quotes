...
let quotes = [
 ...
 // The 'getValue' Function Returns A Random Value Between 0 And 255

 const getValue = () => Math.floor(Math.random() * 256);

 // The 'getColor' Function Returns A Random Color

 const getColor = () => 'rgb(' + getValue() + ', ' + getValue() + ', ' + getValue() + ')';

 // The 'setColor' Function Changes The Background Color To A Random Color

 const setColor = () => document.querySelector('body').style.backgroundColor = getColor();
 ...
 // The 'printTags' Function Displays The Tags Of A Quote, If They Are Exist
